...
class TwoStageDetector(BaseDetector):
    ...
    def extract_feat(self, batch_inputs: Tensor) -> Tuple[Tensor]:
        ...
        """
        #batch_inputs_rgb  = batch_inputs[:,0:3,:,:]
        #batch_inputs_ir  = batch_inputs[:,3:6,:,:]

        # ####CEHCK####
        # img_rgb = batch_inputs[0, 0:3, :, :].cpu().numpy().transpose((1, 2, 0))
        # img_ir = batch_inputs[0, 3:6, :, :].cpu().numpy().transpose((1, 2, 0))
