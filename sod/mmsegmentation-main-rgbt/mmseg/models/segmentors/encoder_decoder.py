...
from mmseg.fusion.cross_attention3 import CrossAttentionFusion
...
class EncoderDecoder(BaseSegmentor):
    ...
    def __init__(self,
        ...
        #self.CrossAttentionFusion = CrossAttentionFusion(dim_list=[128,64,32,16])
    ...
    def extract_feat(self, inputs: Tensor) -> List[Tensor]:
        ...
        if is_rgbt:
            x = tuple(self._merge_rgbt_features(x, batch_size))
